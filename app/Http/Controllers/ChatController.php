            ...
            if (auth()->user() != null) {
                ...
                if ($request->type == 'text') {
                    ...
                    if ($request->hasFile('message')) {
                        $uniqueid = uniqid();
                        $original_name = $request->file('message')->getClientOriginalName();
                    ...
                    $extension = $request->file('message')->getClientOriginalExtension();
                    $filename = Carbon::now()->format('Ymd') . '_' . $uniqueid . '.' . $extension;
                    $audiopath = url('/storage/uploads/videos/' . $filename);
                    $path = $file->storeAs('public/uploads/videos/', $filename);
                    ...
                    $extension = $request->file('message')->getClientOriginalExtension();
                    $filename = Carbon::now()->format('Ymd') . '_' . $uniqueid . '.' . $extension;
                    $audiopath = url('/storage/uploads/files/' . $filename);
